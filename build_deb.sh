...
#   /usr/lib/kubuno/modules/photos/{kubuno-photos, module.toml, frontend/}
#   /usr/share/kubuno/modules/photos/migrations/*.sql
#   /etc/kubuno/modules/photos/config.toml.example
#
# Usage :
